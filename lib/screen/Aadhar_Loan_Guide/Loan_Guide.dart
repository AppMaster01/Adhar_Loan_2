...
class AadharLoanGuide extends StatefulWidget {
  const AadharLoanGuide({super.key});

  @override
  State<AadharLoanGuide> createState() => _AadharLoanGuideState();
}

class _AadharLoanGuideState extends State<AadharLoanGuide> {
  @override
                  ...
                  child: Column(children: [
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return controllerselectColorchange.getselect(() {
                          controller.showbuttonad(
                              context,
                              '/AadharLoanGuideDetail',
                              '/AadharLoanGuide',
                              details[index]);
                        }, '${tital[index]}');
                      },

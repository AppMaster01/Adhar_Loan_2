...
class AboutAadharDetails extends StatefulWidget {
  const AboutAadharDetails({super.key});

  @override
  State<AboutAadharDetails> createState() => _AboutAadharDetailsState();
}

class _AboutAadharDetailsState extends State<AboutAadharDetails> {
        ...
        body: Container(
          ...
          child: Stack(
            children: [
              ...
              banner.getBN('/AboutAadharDetails')
            ],
          ),
        ),
      ),
